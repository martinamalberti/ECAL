...
DrawLocalCorrections(string filename, bool localEta, string outdir, string outname, bool drawFit){
  ...
  for (int mod=0; mod<Ntempl; mod++){
    ...
    g_EoP_Data[mod] -> SetMarkerColor(kGreen+2); 
    g_EoP_Data[mod] -> SetLineColor(kGreen+2); 
